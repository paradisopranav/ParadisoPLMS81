...
//WebUI.click(findTestObject('Enrollment Method Self enrollment in course/Page_Enrolment Methods/dropdown open self'))
//WebUI.selectOptionByValue(findTestObject('Object Repository/Enrollment Method Self enrollment in course/Page_Enrolment Methods/select_Choose.                    Manual en_fb9bc6'), 
//   '/enrol/editinstance.php?type=self&courseid=1159', true)
//Chatgpt code
// Store the test object in a variable
TestObject dropdown = findTestObject('Enrollment Method Self enrollment in course/Page_Enrolment Methods/dropdown open self')

try {
    // Attempt to select the dropdown option
    WebUI.selectOptionByLabel(dropdown, 'Self enrolment', true)
}
catch (StaleElementReferenceException e) {
    WebUI.delay(2)

    dropdown = findTestObject('Enrollment Method Self enrollment in course/Page_Enrolment Methods/dropdown open self')
...
WebUI.click(findTestObject('Object Repository/Enrollment Method Self enrollment in course/Page_Self enrolment/input_Custom welcome message_submitbutton'))

WebUI.click(findTestObject('Object Repository/Enrollment Method Self enrollment in course/Page_Enrolment Methods/i_Self enrolment (Student)_icon fa fa-eye f_5a2390'))

WebUI.delay(2)

WebUI.click(findTestObject('Object Repository/Enrollment Method Self enrollment in course/Page_Enrolment Methods/i_Self enrolment (Student)_icon fa fa-eye-s_a7dab8'))

WebUI.click(findTestObject('Object Repository/Enrollment Method Self enrollment in course/Page_Enrolment Methods/i_Self enrolment (Student)_icon fa fa-trash_52b6ab'))

WebUI.click(findTestObject('Object Repository/Enrollment Method Self enrollment in course/Page_Enrolment Methods/button_Continue'))

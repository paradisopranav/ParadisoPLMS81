...
WebUI.click(findTestObject('Object Repository/Page_Learning Paths/span_Enrol Users'))

WebUI.setText(findTestObject('Object Repository/Page_qa learning path 28022025/input_Search_potentialusers_searchtext'), 
    'hruta')

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_qa learning path 28022025/select_hruta hruta (manashhmail.com)hruta1 _60505f'), 
    '24315', true)
...
WebUI.click(findTestObject('Object Repository/Page_Learning Paths/a_Users_1'))
...
WebUI.click(findTestObject('Object Repository/Page_Learning Paths/a_Cohorts_1'))

WebUI.click(findTestObject('Object Repository/Page_Learning Paths/a_Overview_1'))

...
WebUI.click(findTestObject('ManagePeopleUpload/Page_PLMS Administration Users Accounts Upload Users/input_File_userfilechoose'))

WebUI.uploadFile(findTestObject('Page_PLMS Administration Users Accounts Upload Users/input_Attachment_repo_upload_file'), 
    file)

WebUI.click(findTestObject('ManagePeopleUpload/Page_PLMS Administration Users Accounts Upload Users/button_Upload'))

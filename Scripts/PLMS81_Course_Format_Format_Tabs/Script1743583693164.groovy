...
TestObject FormatTabs = findTestObject('Single Course Format/Page_Edit course settings/Select course format dropdown')

try {
    // Attempt to select the dropdown option
    WebUI.selectOptionByLabel(FormatTabs, 'Format Tabs', true)
}
...
WebUI.click(findTestObject('Course Format Tab/format togggle on'))

WebUI.click(findTestObject('Course Format Tab/format toggle off'))

...
TestObject weeklyformat = findTestObject('Single Course Format/Page_Edit course settings/Select course format dropdown')

try {
    // Attempt to select the dropdown option
    WebUI.selectOptionByLabel(weeklyformat, 'Weekly format', true)
}

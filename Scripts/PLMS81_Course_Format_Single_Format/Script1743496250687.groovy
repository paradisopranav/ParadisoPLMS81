...
TestObject dropdown = findTestObject('Single Course Format/Page_Edit course settings/Select course format dropdown')

try {
    // Attempt to select the dropdown option
    WebUI.selectOptionByLabel(dropdown, 'Single activity format', true)
}
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Single Course Format/Page_Edit course settings/select_Assignment            Book          _8bb9ff'), 
    'resource', true)
